...
class CC_DLL Flappy_birdPlayer : public CCObject
{
public:
...
private:
    static Flappy_birdPlayer *s_sharedInstance;
    static Flappy_birdPlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    Flappy_birdPlayer(void);
